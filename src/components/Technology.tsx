    ...
    technologies: [
      {
        ...
        description: "Высокоточная резка металла толщиной до 20 мм. Идеальные края без дополнительной обработки.",
        specs: ["Точность: ±0.1 мм", "Скорость: до 100 м/мин", "Толщина: 0.5-20 мм"]
      },
      {
        icon: Settings,
